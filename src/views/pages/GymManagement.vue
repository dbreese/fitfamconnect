                ...
                <template #content v-if="hasGym">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <form @submit.prevent="handleSubmit" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Billing Address -->
                            <div class="col-span-full">
                                <h4 class="text-lg font-semibold mb-3">{{ t('gym.billingAddress') }}</h4>
                            </div>

                            <div class="field col-span-full">
                                <label for="street" class="font-medium">{{ t('gym.streetAddress') }} *</label>
                                <InputText
                                    id="street"
                            ...
                            <div class="field">
                                <label for="city" class="font-medium">{{ t('gym.city') }} *</label>
                                <InputText id="city" v-model="formData.billingAddress.city" required class="w-full" />
                            </div>

                            <div class="field">
                                <label for="state" class="font-medium">{{ t('gym.state') }} *</label>
                                <Select
                                    id="state"
                            ...
                            <div class="field">
                                <label for="zipCode" class="font-medium">{{ t('gym.zipCode') }} *</label>
                                <InputText
                                    id="zipCode"
                            ...
                            <div class="field">
                                <label for="country" class="font-medium">{{ t('gym.country') }}</label>
                                <InputText id="country" v-model="formData.billingAddress.country" class="w-full" />
                            </div>
