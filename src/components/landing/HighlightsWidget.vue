...
<template>
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
        <div class="text-center">
            ...
            <span class="text-muted-color text-2xl">{{ $t('highlights.subTitle') }}</span>
        </div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
            ...
            >
                <img src="/images/mockup.png" class="w-2/3" alt="mockup mobile" />
            </div>
        ...
        <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
            <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                ...
                <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">
                    {{ t('highlights.highlight2Title') }}
                </div>
                <span
                    class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-0"
                    style="max-width: 650px"
                    >{{ $t('highlights.highlight2Text') }}</span
                >
            </div>
            ...
            <div
                ...
                style="border-radius: 8px"
            >
                <img src="/images/mockup-desktop.svg" class="w-11/12" alt="mockup" />
            </div>
        </div>
    </div>
</template>
