export const messages = {
    ...
    profile: {
        ...
        noChangesDetail: 'No changes were made to your profile.',
        updateSuccess: 'Profile Updated',
        updateSuccessDetail: 'Your profile has been updated successfully.',
        updateError: 'Update Failed',
        updateErrorDetail: 'Failed to update your profile. Please try again.',
        pinCode: {
            title: 'Pin Code',
            hasPinCode: 'Pin code is set',
            noPinCode: 'No pin code set',
            setPinCode: 'Set Pin Code',
            changePinCode: 'Change Pin Code',
            removePinCode: 'Remove Pin Code',
            dialogTitle: 'Manage Pin Code',
            newPinCode: 'New Pin Code',
            confirmPinCode: 'Confirm Pin Code',
            enterPinCode: 'Enter 4-6 digit pin code',
            helpText: 'Pin code must be 4-6 digits and can be used for quick check-in at kiosks.',
            cancel: 'Cancel',
            save: 'Save',
            successTitle: 'Success',
            errorTitle: 'Error',
            updatedSuccessfully: 'Pin code updated successfully',
            removedSuccessfully: 'Pin code removed successfully',
            updateFailed: 'Failed to update pin code',
            removeFailed: 'Failed to remove pin code',
            fillBothFields: 'Please fill in both pin code fields',
            mismatch: 'Pin codes do not match',
            invalidFormat: 'Pin code must be 4-6 digits'
        }
    },
    landing: {
        tabs: {
    ...
    memberships: {
        ...
        noNotes: 'No notes',
        selectPlan: 'Select a plan for this member',
        notesPlaceholder: 'Add notes about this member...',
        planHelp: 'Select a single plan for this member',
    ...
    schedules: {
        ...
        validation: {
            ...
            startDateTimeRequired: 'Start date and time is required',
    ...
    root: {
        users: {
            ...
            subtitle: 'Manage all users and their roles in the system (Root Access)',
            newUser: 'New User',
            editUser: 'Edit User',
            username: 'Username',
            fullname: 'Full Name',
            ...
            deleteConfirmation: 'Delete Confirmation',
            deleteMessage: 'Are you sure you want to delete user "{email}"? This will prevent them from accessing the system.',
            activateConfirmation: 'Activate User',
            activateMessage: 'Are you sure you want to activate user "{email}"?',
            deactivateConfirmation: 'Deactivate User',
            deactivateMessage: 'Are you sure you want to deactivate user "{email}"? This will prevent them from accessing the system.',
            remoteId: 'Remote ID',
            remoteIdHelp: 'External system identifier (e.g., Clerk user ID)',
            selectRoles: 'Select Roles',
            rolesHelp: 'Users must have at least one role. Multiple roles can be assigned.',
            success: {
            ...
            error: {
                ...
                deleteFailed: 'Failed to deactivate user',
                activateFailed: 'Failed to activate user',
                rolesUpdateFailed: 'Failed to update user roles'
            },
            validation: {
                usernameRequired: 'Username is required',
                emailRequired: 'Email is required',
                emailInvalid: 'Please enter a valid email address',
                remoteIdRequired: 'Remote ID is required',
